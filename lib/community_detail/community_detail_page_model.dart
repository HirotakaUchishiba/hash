...
class CommunityDetailPageModel extends ChangeNotifier {
  ...
  Future<void> fetchFollowingCommunityDetailList(
    ...
    final snapshot = await FirebaseFirestore.instance
        ...
        //ここで一旦コミュニティが誰によって作られたかを判別できるようにするためにuidを入れる
        .doc(followingCommunity.creatorUid)
  ...
  Future<void> getBlockBooleanValue(String followingCommunityCreatorUid) async {
    final uid = FirebaseAuth.instance.currentUser!.uid;
    await FirebaseFirestore.instance
        .collection('users')
        .doc(uid)
  ...
  Future<void> addText(String message, String followingCommunityId,
      String followingCommunityCreatorUid) async {
  ...
  Future<void> deleteBookMark(String followingCommunityId) async {
    var db = FirebaseFirestore.instance;
    final uid = FirebaseAuth.instance.currentUser!.uid;
