...
import 'package:hash/add_community/add_community_page.dart';
import 'package:hash/community_detail/following_community_detail_page.dart';
              ...
              Consumer<CommunityPageModel>(builder: (context, model, child) {
                ...
                return Expanded(
                  child: GridView.count(
                      crossAxisCount: Device.get().isTablet?3:2, children: followingCommunityWidgets),
                );
              })
            ],
          ),
