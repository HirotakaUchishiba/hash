...
import 'package:hash/club_detail/academic_study_club_detail_page.dart';
import 'package:hash/club_detail/all_round_club_detail_page.dart';
import 'package:hash/club_detail/art_club_detail_page.dart';
import 'package:hash/club_detail/athletic_club_detail_page.dart';
import 'package:hash/club_detail/badminton_club_detail_page.dart';
import 'package:hash/club_detail/baseball_club_detail_page.dart';
import 'package:hash/club_detail/basketball_club_detail_page.dart';
import 'package:hash/club_detail/cultural_club_detail_page.dart';
import 'package:hash/club_detail/dance_club_detail_page.dart';
import 'package:hash/club_detail/futsal_club_detail_page.dart';
import 'package:hash/club_detail/light_music_club_detail_page.dart';
import 'package:hash/club_detail/marin_sports_club_detail_page.dart';
import 'package:hash/club_detail/martial_arts_club_detail_page.dart';
import 'package:hash/club_detail/other_field_club_detail_page.dart';
import 'package:hash/club_detail/other_music_club_detail_page.dart';
import 'package:hash/club_detail/other_sports_club_detail_page.dart';
import 'package:hash/club_detail/outdoor_club_detail_page.dart';
import 'package:hash/club_detail/single_part_club_detail_page.dart';
import 'package:hash/club_detail/soccer_club_detail_page.dart';
import 'package:hash/club_detail/social_study_club_detail_page.dart';
import 'package:hash/club_detail/tennis_club_detail_page.dart';
import 'package:hash/club_detail/volleyball_club_detail_page.dart';
import 'package:hash/club_detail/volunteer_club_detail_page.dart';
import 'package:hash/club_detail/winter_sports_club_detail_page.dart';
              ...
              children: [
                Consumer<ClubListModel>(builder: (context, model, child) {
                  ...
                  final List<Widget> academicStudyClubWidgets =
                      academicStudyClubs
                          .map((academicStudyClub) => academicStudyClubWidget(
                              context, academicStudyClub))
                          .toList();
                  ...
                  final List<Widget> soccerClubWidgets = soccerClubs
                      .map(
                          (soccerClub) => soccerClubWidget(context, soccerClub))
                      .toList();

                  final List<Widget> futsalClubWidgets = futsalClubs
                      .map(
                          (futsalClub) => futsalClubWidget(context, futsalClub))
                      .toList();

                  final List<Widget> tennisClubWidgets = tennisClubs
                      .map(
                          (tennisClub) => tennisClubWidget(context, tennisClub))
                      .toList();
              ...
              child: athleticClub.imageURL != null
                ...
                child: Container(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: athleticClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: academicStudyClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: academicStudyClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: singlePartClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: singlePartClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: baseballClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: baseballClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: badmintonClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: badmintonClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: basketballClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: basketballClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
              ...
              child: volleyballClub.imageURL != null
                  ? Container(
                      ...
                      child: Container(
                        ...
                        height: 130,
                        child: CachedNetworkImage(
                          imageUrl: volleyballClub.imageURL!,
                          fit: BoxFit.fill,
                        ),
                      ),
                    )
            ...
            child: ClipRRect(
              ...
              child: allRoundClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: allRoundClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: martialArtsClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: martialArtsClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: marinSportsClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: marinSportsClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: winterSportsClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: winterSportsClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: otherSportsClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: otherSportsClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: otherMusicClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: otherMusicClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: socialStudyClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: socialStudyClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
            ...
            child: ClipRRect(
              ...
              child: volunteerClub.imageURL != null
                ...
                child: Container(
                  ...
                  height: 130,
                  child: CachedNetworkImage(
                    imageUrl: volunteerClub.imageURL!,
                    fit: BoxFit.fill,
                  ),
                ),
              )
